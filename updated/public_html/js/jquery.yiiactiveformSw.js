...
//$('#'+settings.summaryID).hide();
	...
	$.fn.yiiactiveform.updateInput = function(attribute, messages, form) {
		...
		if ($container.hasClass('error'))
			$container.popover('hide').popover('disable');//2012-05-25
...
//$container.attr('title',messages[attribute.id][0]);
/* old...
var template = '<div class="arrow"></div><div class="inner popErrorMessage"><div class="content"><p></p></div></div>';
$container.attr('data-content','<div>'+messages[attribute.id][0]+'</div>');
$container.popover({placement:'top', html:true, template:template, delayOut:1000}).popover('show');
*/

var template = messages[attribute.id][0];
$container.attr('data-content',template);
$container.popover({
    placement:'top',
    delay:{ show: 100, hide: 2000 },//delayOut:1000,
    template:'<div class="popover errorMessage '+attribute.id+'"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"><p></p></div></div></div>'
}).popover('enable').popover('show');

window.setTimeout(function() { $container.popover('hide'); }, 2000);
