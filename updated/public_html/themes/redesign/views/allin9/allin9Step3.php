<div class="allin9-box allin9-step3">

<div id="allin9-step3-form" class="form">
...
<?php 
    ...
    $form=$this->beginWidget('CActiveFormSw', array(
            'action'=>Yii::app()->createUrl('/allin9/step3'),
            'id' => 'Allin9Step3Form',
                                                    ...
                                                    if (! hasError) {
                                                      $.ajax({
                                                        ...
                                                        success: function(ret) {
                                                            if ($('#Allin9Step3Form_subStep').val()==1) 
                                                            {
                                                            	$('#fill2cont').fadeIn(1000);
                                                            	$('#Allin9Step3Form_subStep').val(2);
                                                            	
                                                            	$('#allin9-step3-form .btn').button('reset');                                                            	
                                                            	$('#allin9-step3-form .btn').html('Upgrade Now');
                                                            	$('#allin9-step3-form .btn').addClass('btn-danger');
                                                            }
                                                            else
                                                            {
//alert(ret);//
            ...
            <?php 
            	echo $form->dropDownList(
                        ...
                        array(
                            ...
                            'onChange'=> 'javascript:allin9_step3_setStates()',
...
<script>
    $('#allin9-step3-form').keyup(function(e) {
        if (e.keyCode == 13)
