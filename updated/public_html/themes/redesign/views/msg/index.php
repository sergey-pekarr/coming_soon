...
<div style="padding-top: 10px; margin-bottom: 20px;">
    <p>
        To view your conversations between users, simply click on the username or message
        you wish to view.</p>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="message-row">
                            ...
                            <span style="font-size: 12px;" class="msg-fade">
								<?php 
									//Temporary we are currently support text msg only. 
									//In the future we need to support html, so we will need method to extract text from html
									//Old ONL has the method
									echo substr($item['text'],0,50); 
								?></span>
                        </td>
                        ...
                        <td width="10">
                            <a onclick="archiveThread('<?php echo $msgid; ?>',this); return false;" href="#" title="delete the message">
