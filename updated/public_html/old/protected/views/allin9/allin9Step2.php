<div class="logoText2" style="top:0">
	<span><a href="site/page/contact"> 24/7 Live toll free customer support </a> </span> 
</div>

<div style="text-align:center;">
	<img id="logo-allin9" src="/images/design/logo-allin9.png" />
	<br />
...
<div class="allin9-box allin9-step2">
	
	<form id="allin9-step2-form" action="/allin9/step2/" method="post">
...
<!--
	...
	<?php if ($payment_options)
		    foreach ($payment_options as $o) { ?>
				prices[<?php echo $o['id'] ?>] = <?php echo ($o['price_trial']!=0) ? $o['price_trial'] : $o['price'] ?>;
	<?php } ?>
...
<?php */ ?>
	...
	{
		$(".allin9-step2 input").removeAttr('checked');
		$(".allin9-step2 .tr_"+id+" input").attr('checked', 'checked');
