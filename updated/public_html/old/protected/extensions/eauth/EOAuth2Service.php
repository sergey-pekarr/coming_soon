...
abstract class EOAuth2Service extends EAuthServiceBase implements IAuthService {
	...
	//n 2012-08-02: need to access active token, then send to FaceBook instance to access fb account. Please see ProfileController.actionfbimage 
	public function getStoredAccessToken(){
		if($this->access_token != ''){
			return $this->access_token;
		}
		if($this->getState('auth_token') != null) {
