	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
                ...
                'old/<controller:(site)>/<action:(login|fblogin|logout|Registration|registration|Signin|signin|registrationStep2|facebooklogin|snoopy|support|errors)>'=>'<controller>/<action>',
				'old/<controller:(site)>/<action:(autologin)>/<idd:\w{32}>/<hash:\w+>'=>'<controller>/<action>',
				
                'old/<controller:(site)>/<view:\w+>'=>'<controller>/page',            
                
				'old/<controller:(aff)>/<affid:\d+>' => '<controller>/index',        
        
				'old/<controller:(profile)>/<id:\w{32}>'=>'<controller>/index',

				'old/<controller:(payment)>/<id:\w{37}>'=>'<controller>/index',
				'old/<controller:(payment)>/<id:\w{5}>'=>'<controller>/index',
				
				
				'old/<controller:(thread)>/<id:\w{32}>'=>'<controller>/index',
				'old/<controller:(thread)>/<id:\w{32}>/<msgid:\d{1,10}>'=>'<controller>/index',
				'old/<controller:(thread)>/<action:\w+>/<id:\w{32}>'=>'<controller>/<action>',
				'old/<controller:(msg)>/<action:\w+>/<id:\w{32}>/<msgid:\d{1,10}>'=>'<controller>/<action>',
