...
<?php
    $form=$this->beginWidget('CActiveFormSw', array(
            'action'=>Yii::app()->createUrl('/admin/users/messageSend'),
            'id'    => 'messageForm',
            'enableAjaxValidation' => true,
            'enableClientValidation'=> true,
            'clientOptions' => array(
                //'validationUrl'=>Yii::app()->createUrl('/admin/users/messageSend'),
    ...
    <div class="row type">
        <dd>
            ...
            <?php echo $form->checkBoxList(
                $model, 
                'type', 
                array('private'=>'Private', 'email'=>'Email'),
                array('separator'=>'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;')
            ); ?>
        </dd>
...
<?php $this->endWidget(); ?>   
    ...
    <div class="submit">
        <button 
            ...
            onclick="javascript:formSubmit('sendMessageBox');" 
        >Send</button>
