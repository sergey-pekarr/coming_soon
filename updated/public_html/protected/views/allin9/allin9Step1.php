...
<div id="allin9-step1-form" class="form">
...
<?php 
    ...
    $form=$this->beginWidget('CActiveFormSw', array(
            'action'=>Yii::app()->createUrl('/allin9'),
            'id' => 'Allin9Step1Form',
            ...
            'clientOptions' => array(
                ...
                'afterValidate' => "js: function(form, data, hasError) {
                                                    ...
                                                    if ( typeof(data['Allin9Step1Form_ip'])!='undefined')
                                                    {
                                                    ...
                                                    if (! hasError) {
                                                      $.ajax({
                                                        ...
                                                        success: function(ret) {
                                                        	...
                                                        	window.location.href='/allin9/step2';
															
                                                        }
                                                      });                                                        
                                                    }
                                                    else
                                                       $('#allin9-step1-form .btn').button('reset');
                                                    return false;
                }"                
		...
		<dd>
            <?php echo $form->dropDownList(
                        ...
                        array(
                            ...
                            'onChange'=> 'javascript: allin9_onChangeCountry(this);',//'onChange'=> 'javascript: countryAllin9 = this.value; $("input#Allin9Step1Form_city").val("").focus()',
		...
		<dd>
            <?php echo $form->dropDownList(
                        ...
                        array(
                            ...
                            //'onChange'=> 'javascript: countryAllin9 = this.value; $("input#Allin9Step1Form_city").val("").focus()',
                            //'onChange'=> 'javascript:updateStates(this.value)',
                        )
                   ); ?>
        </dd>
...
<div class="center">
	<button 
	    ...
	    onclick="javascript:formSubmit('allin9-step1-form');"    
	>Continue »</button>
</div>
