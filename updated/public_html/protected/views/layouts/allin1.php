...
<head>
    ...
    switch($deviceType){
    	case 'mobile': 
    		CHelperAssets::cssUrl('allin1Mobile', $compressCss, $combineCss); 
    		break;
    	
    	case 'tablet': 
    		CHelperAssets::cssUrl('allin1Tablet', $compressCss, $combineCss); 
    		break;
    	
    	default: 
    		CHelperAssets::cssUrl('allin1', $compressCss, $combineCss); 
    		break;			
    }
    ?>
...
<div id="wrapper-allin1">
	...
	<div style="text-align: center; margin-top: 10px;">
		<?php if($deviceType == 'mobile' || $deviceType == 'tablet') { ?>
			<span>If your device is not mobile or tablet, </span><a href="/allin1/normal">click here for normal signup</a>
		<?php } ?>
	</div>
