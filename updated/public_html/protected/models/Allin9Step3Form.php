...
class Allin9Step3Form extends CFormModel
{
	public $subStep;
    ...
    public function init()
    {
        ...
        $this->subStep = isset($_POST['Allin9Step3Form']['subStep']) ? $_POST['Allin9Step3Form']['subStep'] : 1;
	...
	public function rules()
	{
		...
		$rules = array(
			array('ccname, ccnum, ccvv', 'required'),
	...
	public function doAllin9Step3($modelPayment, $price_id)
	{
		if(!$this->hasErrors())
        {
			...
			{
				$redirectUrl = $modelPayment->startTransaction(Yii::app()->user->id, $price_id, $this->attributes);//redirect to payment page of paymode
				if ($redirectUrl)
					return $redirectUrl;
				else
					return '/allin9/step4';
