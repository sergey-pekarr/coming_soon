...
class Allin1Step3Form extends CFormModel
{
	public $subStep;
    ...
    public function init()
    {
        ...
        $this->subStep = isset($_POST['Allin1Step3Form']['subStep']) ? $_POST['Allin1Step3Form']['subStep'] : 1;
	...
	public function doAllin1Step3($modelPayment, $price_id)
	{
		if(!$this->hasErrors())
        {
